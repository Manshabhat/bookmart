...
if(isset($_POST["submit"]))
{
  ...
  $Name=$_POST['Name'];
    ...
    $q = "INSERT INTO `users`(`Name`,`email`,`password`,`Roll`,`Status`,`plan`,`days`) VALUES ('$_POST[Name]','$_POST[email]','$_POST[password]','user','active','free','15')";
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light ">
        <div class="container-fluid">
          <a class="navbar-brand l2" href="#"><span class="l1">SHOPPY</span>KART</a>
      ...
      <h1 style="color: white; padding-right:70rem; padding-bottom: 4rem;">Signup</h1>
   ...
   <div class="main">
        <form action="" method="post" class="f">
            <div class="main-body">
            <h3 style="color:black; padding-left: 4rem;">Sign Up</h3> 
                <div class="r">
                <div class="col" >
                     <span style="display: flex;" ><input type="text" style="background-color: lightgrey;padding:8px; border-top-right-radius:0%; border-bottom-right-radius:0%;border:none;" placeholder="enter your name" name="Name" class="form-control"><i class="fa-solid fa-user fa-2x" style="background-color: lightgrey; padding:3px;"></i></span>
                    </div>
                     <div class="col" >
                     <span style="display: flex;" ><input type="email" style="background-color: lightgrey;padding:8px; border-top-right-radius:0%; border-bottom-right-radius:0%;border:none;" placeholder=" enter email" name="email" class="form-control"><i class="fa-solid fa-envelope fa-2x" style="background-color: lightgrey; padding:3px;"></i></span>
                    </div>
               ...
               <span style="display: flex;"> <input type="password" style="background-color: lightgrey;padding:8px; border-top-right-radius:0%; border-bottom-right-radius:0%;border:none;" placeholder="Password" name="password" class="form-control"><i class="fa-solid fa-lock fa-2x" style="background-color: lightgrey; padding:3px;"></i></span>
                     ...
                     <!--<h5 style="padding-left:2rem; font-size:1.1rem;"> Forgot Password?<span style="color:black;">Click</span> User? <span style="color:black;">Signup here</span> </h5>-->
                     <div class="r">
                        <div class="col">
    ...
    <!--<div class="main">
        <form action="" method="post" class="f">
            ...
            <div class="r">
                    <div class="col">
                        Name:<input type="text" placeholder="enter your email" name="name" class="form-control">
                    </div>
