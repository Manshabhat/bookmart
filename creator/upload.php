...
if(isset($_POST["submit"]))
{
  $dir="../adminn/uploads/";
    ...
    $q = "INSERT INTO `products`(`name`,`price`,`des`,`cat`,`image`) VALUES ('$_POST[name]','$_POST[price]','$_POST[des]','books','$fullpath')";
...
<main style="margin-top: 58px">
  ...
  <label class="form-label" for="formControlLg">Product Name</label>
    ...
    <div class="form-outline mt-4">
  <input type="text" id="formControlLg" name="price" class="form-control form-control-lg"  required/>
