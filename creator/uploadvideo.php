...
if(isset($_POST["submit"]))
{
  $dir="../adminn/uploads/";
    ...
    $q = "INSERT INTO `products`(`name`,`price`,`des`,`cat`,`image`) VALUES ('$_POST[name]','0','$_POST[des]','video','$fullpath')";
...
<div class="form-outline mt-4">
  <input type="file" id="formControlLg" name="file1" class="form-control form-control-lg" accept=".mp4" required/>
