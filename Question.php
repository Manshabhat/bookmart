...
<body>
 ...
 <!-- <div class="container-fluid ">
  ...
  <div class="container-fluid overflow-hidden" style="background-color:#f7f6f6;">
    ...
    <h1 class="pt-5">View Question paper</h1>
    <?php
    $q=mysqli_query($con,"SELECT * FROM `products` WHERE `cat`='qpdf'");
    while($D=mysqli_fetch_assoc($q))
    {
       echo'<div class="rr text-center">
       <h4>'.$D["name"].'</h4>
       <h3>'.$D["des"].'</h3>
       <a class="btn btn-primary" target="_black" href="adminn/'.$D['image'].'" alt"">View Pdf</a></div>';
